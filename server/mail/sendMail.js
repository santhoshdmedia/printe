...
const otpMail = async (values) => {
  ...
  <div style="max-width: 600px; background: white; padding: 30px; border-radius: 10px; box-shadow: 0 3px 12px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin-bottom: 25px;">
      <img   fetchpriority="high" loading="eager" src="https://printe.in/assets/logo-BQbty1hL.png" alt="Printe Logo" style="max-height: 70px; width: auto; display: block; margin: 0 auto;" />
    </div>
