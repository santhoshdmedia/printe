...
const { addProduct, getProduct, deleteProduct, editProduct, getProductVariantPrice, getHistoryProducts, getBannerProducts, addProductDescription, getProductDescription, updateProductDescription, deleteProductDescription,getAllProductsSimple } = require("./controller_import");
...
router.get("/get_product", getAllProductsSimple);
