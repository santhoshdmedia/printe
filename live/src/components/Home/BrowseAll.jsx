    ...
    <section className="py-10 sm:py-12 md:py-16 px-3 sm:px-6 md:px-16 bg-white text-black">
      ...
      <div className="text-center mb-12 md:mb-16 relative">
        <div className=" lg:block absolute inset-0 flex items-center justify-center opacity-5">
          <div className="text-5xl sm:text-7xl lg:text-9xl font-black text-gray-900">CATEGORIES</div>
        </div>
        <div className="relative z-10">
          <span className="inline-block text-[#f2c41a] text-xs sm:text-sm font-bold tracking-widest uppercase mb-2">
            Explore Our Collection
          </span>
          <h2 className="text-2xl sm:text-4xl md:text-5xl  font-bowlby text-gray-900 mb-3 ">
            Browse{" "}
            <span className="bg-gradient-to-r from-[#f2c41a] to-yellow-500 bg-clip-text text-transparent font-bowlby">
              Categories
            </span>
          </h2>
          ...
          <SwiperSlide key={category._id} className="flex justify-center !overflow-visible">
            <div className="flex flex-col items-center text-center group ">
              <div
                ...
                group-hover:scale-110 transition-all duration-500 shadow-[0_0_10px_rgba(0,0,0,0.1)] cursor-pointer"
              >
