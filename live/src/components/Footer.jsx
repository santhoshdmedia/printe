      ...
      <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#f2c41a] rounded-lg shadow-lg p-3 border border-gray-800 transform hover:scale-105 transition-transform duration-300 group">
        <Link to="/" className="font-bold text-xl rounded uppercase cursor-pointer">
          <div className="flex flex-row items-center justify-center p-1">
            <img   fetchpriority="high" loading="eager" src={Logo}  alt="Printe Logo" className="w-auto h-12 bg-center bg-cover group-hover:brightness-110 transition-all" />
          </div>
        </Link>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex-1 flex flex-col items-center gap-2 w-full max-w-md">
            ...
            <div className="flex gap-2">
              ...
              <div className="">
                <img   fetchpriority="high" loading="eager" src={Paytm} alt="Paytm" />
              </div>
              <div className="">
                <img   fetchpriority="high" loading="eager" src={Bhimupi} alt="Bhim UPI" />
              </div>
              <div className="">
                <img   fetchpriority="high" loading="eager" src={visa} alt="visa" />
              </div>
              <div className="">
                <img   fetchpriority="high" loading="eager" src={visaelectron} alt="visa Electron" />
              </div>
              <div className="">
                <img   fetchpriority="high" loading="eager" src={Mastro} alt="Mastro" />
              </div>
              <div className="">
                <img   fetchpriority="high" loading="eager" src={Master} alt="Master" />
              </div>
            </div>
