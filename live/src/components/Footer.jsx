...
const Footer = () => {
  ...
  return (
    <div className="pt-16 bg-gray-950 text-white relative  !font-primary">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#f9c114] to-transparent"></div>
      <div className="absolute top-10 left-0 w-40 h-40 rounded-full bg-[#f9c114] opacity-5 -translate-x-20"></div>
      
      {/* Logo container */}
      <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#f9c114] rounded-lg shadow-lg p-3 border border-gray-800 transform hover:scale-105 transition-transform duration-300 group">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 px-[6vw] md:px-[8vw] xl:px-[10vw] items-start py-12 relative z-10">
        {footerItems.map((data, index) => {
          return (
            <ul key={index} className="space-y-4">
              <li className="text-lg font-semibold text-[#f9c114] flex items-center">
                {data.title}
                <div className="w-8 h-0.5 bg-[#f9c114] ml-2"></div>
              </li>
                ...
                return (
                  <li key={subIndex} className="cursor-pointer group/item">
                    <div 
                      ...
                      className={`flex items-center text-gray-400 hover:text-[#f9c114] w-fit !text-sm transition-all duration-200 ${items.link === location.pathname ? "text-[#f9c114] font-medium" : ""}`}
                    >
                      <FaArrowRight size={10} className="mr-2 text-[#f9c114] opacity-0 group-hover/item:opacity-100 transition-opacity" />
                      {items.value}
                    </div>
                  </li>
                );
        ...
        <div className="lg:col-span-1">
          <h1 className="text-lg font-semibold text-[#f9c114] flex items-center pb-4">
            Contact Us
            <div className="w-8 h-0.5 bg-[#f9c114] ml-2"></div>
          </h1>
          <ul className="flex text-gray-400 justify-start items-start flex-col gap-5">
            <li className="flex justify-start items-center gap-3 transition-all duration-200 hover:text-[#f9c114] group">
              ...
              <span><a href="tel:++919987654321" className="hover:text-[#f9c114]">+91 9987654321</a></span>
            </li>
            <li className="flex justify-start items-center gap-3 transition-all duration-200 hover:text-[#f9c114] group">
              <div className="p-2 bg-gray-800 rounded-lg group-hover:bg-[#f9c114] transition-colors duration-300">
                <CiMail size={16} className="text-[#f9c114] group-hover:text-gray-900 transition-colors duration-300" />
              </div>
              <span><a href="mailto:info@printe.in" className="hover:text-[#f9c114]">info@printe.in</a></span>
            </li>
            <li className="flex flex-col justify-start items-start gap-3 mt-2">
              <span className="text-[#f9c114] font-medium">Follow us</span>
              <ul className="flex gap-3 mt-1">
                <li>
                  <Link 
                    to={'https://www.facebook.com/profile.php?id=61578118705571&sk=about'} 
                    target="_blank"
                    className="flex items-center justify-center p-2 bg-gray-800 rounded-lg hover:bg-[#f9c114] transition-all duration-300 group"
                  >
                    <FaFacebook size={18} className="text-[#f9c114] group-hover:text-gray-900 transition-colors duration-300" />
                  </Link>
                </li>
                <li>
                  <Link 
                    ...
                    className="flex items-center justify-center p-2 bg-gray-800 rounded-lg hover:bg-[#f9c114] transition-all duration-300 group"
                  >
                    <FaInstagram size={18} className="text-[#f9c114] group-hover:text-gray-900 transition-colors duration-300" />
                  </Link>
                </li>
                <li>
                  <Link 
                    ...
                    className="flex items-center justify-center p-2 bg-gray-800 rounded-lg hover:bg-[#f9c114] transition-all duration-300 group"
                  >
                    <FaTwitterSquare size={18} className="text-[#f9c114] group-hover:text-gray-900 transition-colors duration-300" />
                  </Link>
                </li>
                <li>
                  <Link 
                    ...
                    className="flex items-center justify-center p-2 bg-gray-800 rounded-lg hover:bg-[#f9c114] transition-all duration-300 group"
                  >
                    <FaLinkedin size={18} className="text-[#f9c114] group-hover:text-gray-900 transition-colors duration-300" />
                  </Link>
                </li>
              </ul>
            </li>
      ...
      <div className="px-[6vw] md:px-[8vw] xl:px-[10vw] py-8 border-t border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-[#f9c114] mb-2">Trust & Security Focused</h3>
          ...
          <div className="flex-1 flex flex-col items-center gap-2 w-full max-w-md">
            <h3 className="text-lg font-semibold text-[#f9c114] mb-2">100% SECURE PAYMENTS</h3>
      ...
      <div className="relative z-10 border-t border-gray-800 bg-gray-900 font-primary flex flex-col md:flex-row justify-between items-center py-6 px-[6vw] md:px-[8vw] xl:px-[10vw]">
        <span className="text-sm text-center text-gray-400 order-2 md:order-1">
          © {moment().format("YYYY")} <a href="https://dmedia.in/" className="hover:text-[#f9c114]">Dmedia</a>. All Rights Reserved.
        </span>
        <div className="flex gap-6 mb-4 md:mb-0 order-1 md:order-2">
          <Link to="#" className="text-gray-400 hover:text-[#f9c114] text-sm transition-colors">Privacy Policy</Link>
          <Link to="#" className="text-gray-400 hover:text-[#f9c114] text-sm transition-colors">Terms of Service</Link>
          <Link to="#" className="text-gray-400 hover:text-[#f9c114] text-sm transition-colors">Cookie Policy</Link>
        </div>
      </div>
    </div>
  );
