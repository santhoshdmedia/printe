  ...
  return (
    <Link to={`/categories/${data._id}`} className="mr-10 group flex flex-col items-center justify-center">
      <div className=" bg-primary_faded h-[10rem] w-[10rem] rounded-[50%] shadow-lg">
        <img   fetchpriority="high" loading="lazy" src={data.sub_category_image} alt="" className="relative  object-contain drop-shadow group-hover:scale-110 transition-all duration-700 w-[10rem] h-[10rem]" />
      </div>
