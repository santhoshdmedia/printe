  ...
  return (
    <div>
      ...
      <div className="w-full lg:flex hidden h-[80px] gap-x-10 bg-[#f9c114] shadow-2xl center_div justify-between px-20 sticky top-0 z-10">
              ...
              <div>
                <h1 className="!text-[#121621] hover:cursor-pointer group">
                  <a
                    ...
                    className="center_div justify-start hover:!text-[#121621]   "
                  >
                    <IconHelper.WHATSAPP_ICON className="!text-[#121621] mr-1   " />{" "}
                    +91 9876543210
                  </a>
                </h1>
        ...
        <div className="flex items-center justify-center gap-x-10 w-[50%]">
          ...
          <Link
            to={"/help"}
            className="center_div gap-x-1 border border-[#121621] py-2 px-3 transition-all duration-300 hover:bg-[#121621] hover:text-[#f9c114] rounded group"
          >
            <IconHelper.HELP_ICON className="!text-xl !text-[#121621] group-hover:!text-[#f9c114] " />
            <h1 className="!font-normal text-[12px] text-[#121621] group-hover:text-[#f9c114] text-nowrap">
              Help Center
            </h1>
          </Link>
        </div>
          ...
          >
            <div className="flex flex-row items-center ">
              <img
                src={Logo}
                alt=""
                className="w-auto h-[25px] bg-center bg-contain"
              />
            </div>
          </Link>
