  ...
  return (
    <div>
      {product_type === "3" && (
        <div className=" my-10">
          {" "}
          <DynamicBannear Product_cover_img={Banear} single_product={Carry_bag} />
        </div>
      )}
...
export const DynamicBannear = ({Product_cover_img,single_product}) => {
  // Animation variants
  const containerVariants = {
    hidden: { opacity: 0 },
    visible: {
  ...
  return (
    <div className="w-full  banear__section relative z-0  mb-20 py-2">
      ...
      <div className="max-w-[90%] mx-auto">
        <motion.div
          className="flex flex-col md:flex-row h-[60vh] items-center justify-between gap-12 p-6 rounded-xl  relative"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
          variants={containerVariants}
        >
          ...
          {/* Right Image - Hidden on mobile */}
          <motion.div
            className="hidden md:block flex-shrink-0 absolute bottom-[-150px] right-[100px] z-10 single_product "
            variants={itemVariants}
          >
            <motion.img
              src={single_product}
