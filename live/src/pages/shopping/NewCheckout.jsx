              ...
              <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-200 sticky top-4">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="flex justify-between mb-2">
                    <span>
                      Taxes{" "}
                      <span className="text-sm text-gray-500">(including SGST & CGST {gstRate*100}%)</span>:
                    </span>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between mb-2">
                    <span>Savings<span className="text-sm text-gray-500">({cardData.length} items)</span>:
                    </span>
                  </div>
                  <div className="flex justify-between mb-2">
                    <span>
                  ...
                  <div className="flex justify-between font-bold text-lg mt-4 pt-4 border-t border-gray-200">
                    ...
                    <span>₹{Number(GET_Mrp_savings()+GET_additonal_savings()).toFixed(2)}</span>
                  </div>
                </div>
                  ...
                  <div className="mb-4">
                    ...
                    >
                      <div className="grid grid-cols-2 space-y-2">
                        <Radio value="full" className="!flex !items-center !justify-between h-full !py-2 !px-3 !border !rounded-md">
                          <div>
                        ...
                        <Radio value="half" className="!flex !items-center !justify-between !py-2 h-full !px-3 !border !rounded-md !m-0">
                          <div>
                            <span className="font-medium">50% Advance Payment</span>
                            <div className="text-sm text-gray-600">Pay half now, rest before production</div>
                          </div>
