      ...
      render: (image, record) => (
        <div className="flex items-start gap-4">
          <Link to={`/product/${_.get(record, "product_seo_url", "")}`} target="_blank">
            <img   fetchpriority="high" loading="eager" src={image} alt={record.product_name} className="w-20 h-20 object-contain" />
          </Link>
    ...
    <Spin spinning={loading} indicator={<IconHelper.CIRCLELOADING_ICON className="animate-spin !text-yellow-500" />}>
      {_.isEmpty(cardData) ? (
        <div className="min-h-screen center_div flex-col">
          <img   fetchpriority="high" loading="eager" className="size-[300px] object-contain" src={ImageHelper.EmptyCard} alt="" />
