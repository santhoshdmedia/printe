...
//           <p className="text-gray-600">Sign in using your registered details.</p>
//         </div>

//         <Spin spinning={isLogingIn}>
//           <form onSubmit={handleOnSubmit} className="bg-white p-8 rounded-lg shadow-md">
//             <div className="mb-6">
...
//             <button 
//               className="w-full bg-yellow-400 hover:bg-yellow-500 text-white font-medium py-3 px-4 rounded-md transition duration-200" 
//               type="submit"
//             >
//               Log in
//             </button>
...
//               <p className="text-gray-600 text-sm mb-4">If you don't have an account </p>
//               <Link 
//                 to="/sign-up" 
//                 className="inline-block border border-gray-300 hover:border-gray-400 rounded-md py-2 px-4 text-gray-700 hover:text-gray-900 transition duration-200 text-sm font-medium"
//               >
//                 Register Here
//               </Link>
//             </div>
