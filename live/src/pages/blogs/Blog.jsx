...
const BlogCard = ({ blog, featured = false }) => {
    ...
    return (
      <div className="featured-card">
        <div className="featured-image-wrap">
          {image ? <img   fetchpriority="high" loading="eager" src={image} alt={name} className="featured-image" /> : <div className="image-placeholder" />}
        </div>
  ...
  return (
    <div className="blog-card">
      {image ? <img   fetchpriority="high" loading="eager" src={image} alt={name} className="card-image" /> : <div className="image-placeholder" />}
    ...
    <>
      ...
      <div className="blog-page relative">
        <div className="absolute bottom-0 left-0 !z-0 w-full">
          <img   fetchpriority="high" loading="eager" src="https://printe.s3.ap-south-1.amazonaws.com/1771389440794-gm1nqlp6ood.png" alt="" className="!z-0 h-[500px] lg:h-[1000px] object-center w-full object-cover" />
        </div>
        {/* Hero */}
