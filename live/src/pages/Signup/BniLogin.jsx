        ...
        <div className="w-full -top-6 relative z-10">
          ...
          <div className="mb-6 lg:mb-8 text-center lg:hidden">
            <div className="flex justify-center mb-2 bg-[#facc15] relative">
              ...
              <img   fetchpriority="high" loading="eager" src={logo} alt="Logo" className="h-16 sm:h-24 drop-shadow-md" />
            </div>
            <h1 className="text-2xl  sm:text-3xl font-bold text-gray-900 mb-2">
              <span className="text-red-600">BNI</span> Privilege Login
            </h1>
            <div className="flex justify-center my-4">
              <img   fetchpriority="high" loading="eager" src={Bnilogo} alt="BNI Logo" className="h-20 sm:h-24 drop-shadow-md" />
            </div>
          ...
          <div className="hidden lg:flex mb-6 justify-center">
            <img   fetchpriority="high" loading="eager" src={Bnilogo} alt="BNI Logo" className="h-24 lg:h-28 drop-shadow-md" />
          </div>
      ...
      >
        <div className="max-w-[90%] xl:max-w-[80%] relative z-10 text-center flex flex-col justify-between gap-10 h-[80vh]">
          <div className="w-full flex flex-col justify-center items-center">
            <img   fetchpriority="high" loading="eager" src={logo} alt="logo" className="w-[60%] lg:w-[70%] xl:w-[80%] h-fit z-20" />
