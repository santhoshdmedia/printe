...
const AcBNi = () => {
  ...
  return (
   ...
   <div className="text-right pb-4">
    <Link 
        to={'/products'} 
        className="text-black hover:text-yellow-800 hover:underline transition-colors duration-200 text-sm font-medium"
    >
        View all →
    </Link>
</div>
          ...
          {loading ? (
            ...
            <>
              {sortedProducts.length > 0 ? (
                <GridList data={limitedProducts} type="Product" gridItems="4" productCardType="BNI" />
              ) : (
